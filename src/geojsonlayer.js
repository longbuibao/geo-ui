    ...
    return declare([GraphicsLayer], {
        ...
        constructor: function(options) {
            ...
            if (options.infoTemplate !== false) {
                this.setInfoTemplate(options.infoTemplate || new InfoTemplate("Thông tin", "${*}"));
            }
            // Renderer
            if (options.renderer) {
        ...
        _setDefaultSymbols: function() {
            function getRandomColor(mainColor, transparency) {
                ...
                switch (mainColor) {
                    case "red":
                        return new Color([getRandomInt(150, 255), getRandomInt(0, 255), getRandomInt(0, 255), 1]);
                    case "green":
                        return new Color([getRandomInt(0, 155), getRandomInt(150, 255), getRandomInt(0, 155), 1]);
                    case "blue":
                        return new Color([getRandomInt(0, 255), getRandomInt(0, 255), getRandomInt(150, 255), 1]);
                }
            }
            // Random colors
        ...
        _setCorsSevers: function() {
            ...
            esriConfig.defaults.io.corsEnabledServers.push("http://localhost:3000");
            // Add server
            if (this._url) {
